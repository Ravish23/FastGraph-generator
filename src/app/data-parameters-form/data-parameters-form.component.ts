...
export class DataParametersFormComponent implements OnInit {
  ...
  dataParametersForm: FormGroup; // <--- heroForm is of type FormGroup
  ...
  generateData(params: DataParameters): string {
    ...
    /* for ( var j = 1; j <= params.relationships_number; j++) {
      type = params.relationship_types[this.getRandomNumber(0, params.relationship_types.length - 1)];
      cypher_query += 'CREATE (n' + this.getRandomNumber(1, params.nodes_number) + ')-[r' + j + ':' + type + ']->(n' + this.getRandomNumber(1, params.nodes_number) + ')\n';
    }*/
